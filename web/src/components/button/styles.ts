...
const outlineByIntent: Record<ButtonIntent, string> = {
  ...
  secondary:
    'border border-zinc-700 text-zinc-900 hover:bg-zinc-800 hover:text-white',
  ...
  success:
    'border border-(--alertSuccess) text-(--alertSuccess) hover:bg-(--alertSuccess) hover:text-white',
  warning:
    'border border-(--alertWarning) text-(--alertWarning) hover:bg-(--alertWarning) hover:text-black',
  danger:
