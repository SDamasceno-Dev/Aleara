		...
		<div className="relative min-h-full overflow-x-hidden">
			<main className="relative z-10 mx-auto w-full max-w-3xl px-4 py-20">
				<section className="space-y-4 text-center">
					<h1 className="text-3xl font-semibold tracking-tight text-foreground">Sobre a Aleara</h1>
					<p className="mx-auto max-w-2xl text-balance text-zinc-300/90">
						A Aleara é uma plataforma SaaS moderna e eficiente para acelerar o lançamento de produtos digitais,
						com foco em design consistente, performance e experiência de uso.
					</p>
				</section>
				...
				<section className="mt-10 grid gap-4 md:grid-cols-3">
					{[
						...
						<div key={f.t} className="rounded-lg border border-border/70 bg-card/80 p-5">
